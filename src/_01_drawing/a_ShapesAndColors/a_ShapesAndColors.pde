...
//    #03FF5DSee if you can figure out which number is the width, and which is the height
...
rect(215,200,30,35) ;
//    The #03FFFDfirst 2 numbers specify where to draw it. They are the x and y co-ordinates of the center of the ellipse.
